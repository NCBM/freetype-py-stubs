...
# FT_Outline_MoveToFunc  = CFUNCTYPE(c_int, _Pointer[FT_Vector], py_object)
# FT_Outline_LineToFunc  = CFUNCTYPE(c_int, _Pointer[FT_Vector], py_object)
# FT_Outline_ConicToFunc = CFUNCTYPE(c_int, _Pointer[FT_Vector], _Pointer[FT_Vector], py_object)
# FT_Outline_CubicToFunc = CFUNCTYPE(c_int, _Pointer[FT_Vector], _Pointer[FT_Vector], _Pointer[FT_Vector], py_object)
...
# SVG_Lib_Init_Func        = CFUNCTYPE(c_int, _Pointer[py_object])
# SVG_Lib_Free_Func        = CFUNCTYPE(None, _Pointer[py_object])
# SVG_Lib_Render_Func      = CFUNCTYPE(c_int, FT_GlyphSlot, _Pointer[py_object])
# SVG_Lib_Preset_Slot_Func = CFUNCTYPE(c_int, FT_GlyphSlot, FT_Bool, _Pointer[py_object])
